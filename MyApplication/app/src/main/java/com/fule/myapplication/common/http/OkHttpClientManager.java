package com.fule.myapplication.common.http;
...
//    }
    ...
    private void _postAsyn(String url, ResultCallback callback, File file, String fileKey, Map params) throws IOException {
        Param[] paramsArr = map2Params(params);
