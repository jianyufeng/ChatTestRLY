package com.fule.myapplication.common.superActivity;
...
import com.fule.myapplication.common.activity.ECFragmentActivity;
import com.fule.myapplication.common.superActivity.ui.TopBarView;
import com.fule.myapplication.common.superActivity.ui.dialog.ECProgressDialog;
 ...
 *
 *   SDKCoreHelper.ACTION_KICK_OFF  被踢出
 *
 *
 */
...
public abstract class ECSuperActivity extends ECFragmentActivity implements GestureDetector.OnGestureListener{
    ...
    private static final String TAG = "ECSuperActivity";
    /**
     * 初始化应用ActionBar
     */
...
//        intentfilter.addAction(SDKCoreHelper.ACTION_KICK_OFF);
    ...
    protected abstract void  asynData();
    protected abstract void  logicControlView();
