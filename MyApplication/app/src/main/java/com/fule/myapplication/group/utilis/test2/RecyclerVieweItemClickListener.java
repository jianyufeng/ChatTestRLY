...
public class RecyclerVieweItemClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public RecyclerVieweItemClickListener(final RecyclerView recyclerView,
