...
public class OverflowHelper {
    ...
    public OverflowHelper(Context ctx) {
        mContext = ctx;
        mNormalColor=ContextCompat.getColor(mContext,R.color.android_bai_color);
        mDisabledColor=ContextCompat.getColor(mContext,R.color.text_disabled);
...
//        mPopupWindow.setWidth(414);
    ...
    public void showAsDropDown(View anchor) {
        if(mPopupWindow!=null&&anchor!=null) {
            //更改 mwnu的位置
            mPopupWindow.showAsDropDown(anchor, DensityUtil.dip2px(-121F), DensityUtil.dip2px(20F));
        }
    }
